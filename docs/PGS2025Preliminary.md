...
> 对于做题来说, 部分题目使用动态分析结合查看源码更快. 这里稍微多写一些逆向的方法, 毕竟在离线环境下, 既无法使用在线沙箱也无法在 GitHub 寻找源码.
> 
> 另外: 我不是逆向手, 所以有些地方可能会出错. 
>
> 这道题有混淆, 可以通过 [de4dot](https://github.com/de4dot/de4dot) 去混淆. 然而 Noah 在复盘的时候根本不知道有这个工具, 直接对着一堆乱码硬做的. 
>
