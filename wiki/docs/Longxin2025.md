---
Title: 2025_LongxinCup_WalkThrough
Author: NoahTie @ tratra 什么都会
date: 2025-11-09 15:50:00
tags:
  - 电子数据取证
  - wp
description: 2025 年龙信杯题解
---
...
![Pasted image 20251109174038.png](./attachments/Pasted%20image%2020251109174038.png)
...
![Pasted image 20251109165429.png](./attachments/Pasted%20image%2020251109165429.png)
...
![Pasted image 20251110201558.png](./attachments/Pasted%20image%2020251110201558.png)

![Pasted image 20251110201724.png](./attachments/Pasted%20image%2020251110201724.png)

由于模拟器的设置是简化版的设置, 删除了一些 Activity 的入口, 因此需要通过类似 ActivityManager 的应用来直接启动设置 WLAN 热点的 Activity 才能看到热点密码的设置:

![Pasted image 20251110201610.png](./attachments/Pasted%20image%2020251110201610.png)

![Pasted image 20251110202557.png](./attachments/Pasted%20image%2020251110202557.png)
...
![Pasted image 20251110203600.png](./attachments/Pasted%20image%2020251110203600.png)
...
![Pasted image 20251109170840.png](./attachments/Pasted%20image%2020251109170840.png)

用 XWF 加载解压出来的检材文件夹, 在同步搜索中用正则搜索:

![Pasted image 20251110161217.png](./attachments/Pasted%20image%2020251110161217.png)

在电鸽 APP 的配置文件里面存储有用户的手机号码:

![Pasted image 20251110161310.png](./attachments/Pasted%20image%2020251110161310.png)
...
![Pasted image 20251109172757.png](./attachments/Pasted%20image%2020251109172757.png)
...
![Pasted image 20251109174932.png](./attachments/Pasted%20image%2020251109174932.png)

将其中的第三方包的条目导出为 CSV, 提取包名, 再运行一次 APP 识别, 发现其中有一个 `com.kmxs.reader(七猫免费小说)` 

![Pasted image 20251109174839.png](./attachments/Pasted%20image%2020251109174839.png)
...
![Pasted image 20251110102501.png](./attachments/Pasted%20image%2020251110102501.png)

在设备的用户自定义证书存储目录中也可以看到安装有 HttpCanary 的根证书:

![Pasted image 20251110103026.png](./attachments/Pasted%20image%2020251110103026.png)
...
![Pasted image 20251110104055.png](./attachments/Pasted%20image%2020251110104055.png)

可以看到, 其中的 `APP` 字段是该流量包是哪个 APP 包名传输的. 

在 `APP` 字段中中过滤 `com.zhulang.reader` 包名, 在 `URL` 字段中过滤 `search`:

![Pasted image 20251110110817.png](./attachments/Pasted%20image%2020251110110817.png)

将数据库中访问的 URL 复制出来, 在 Cyberchef 里面处理(URL 解码, 正则匹配查找关键词):

![Pasted image 20251110110924.png](./attachments/Pasted%20image%2020251110110924.png)
...
![Pasted image 20251109190301.png](./attachments/Pasted%20image%2020251109190301.png)

去缓存里搜索 `/search/index.html`:

![Pasted image 20251109190329.png](./attachments/Pasted%20image%2020251109190329.png)

搜索这几个文件:

`http_req_ea384113-d336-438a-a50d-ae3094ebf18e.hcy`

![Pasted image 20251109190845.png](./attachments/Pasted%20image%2020251109190845.png)

`http_req_1b0f44e9-0bda-43b7-9177-caffc84c56a4.hcy`

![Pasted image 20251109191010.png](./attachments/Pasted%20image%2020251109191010.png)

`http_req_79656dfd-1c6e-4841-96cd-8fadef089218.hcy`

![Pasted image 20251109191111.png](./attachments/Pasted%20image%2020251109191111.png)

`http_req_5221af36-35a0-44e8-812b-8451a81f2690.hcy`(最新)

![Pasted image 20251109191149.png](./attachments/Pasted%20image%2020251109191149.png)

`http_req_1b59c69c-7e4b-472e-ba63-badc5af0e8c3.hcy`

![Pasted image 20251109191300.png](./attachments/Pasted%20image%2020251109191300.png)

URL 解码:

![Pasted image 20251109191351.png](./attachments/Pasted%20image%2020251109191351.png)
...
![Pasted image 20251110105022.png](./attachments/Pasted%20image%2020251110105022.png)

把数据库里访问的 URL 复制出来, 在 Cyberchef 里面处理(URL 解码, 正则匹配查找关键词, 去重):

![Pasted image 20251110162949.png](./attachments/Pasted%20image%2020251110162949.png)
...
![Pasted image 20251110111228.png](./attachments/Pasted%20image%2020251110111228.png)
...
![Pasted image 20251110111929.png](./attachments/Pasted%20image%2020251110111929.png)
...
![Pasted image 20251110113206.png](./attachments/Pasted%20image%2020251110113206.png)
...
![Pasted image 20251110113817.png](./attachments/Pasted%20image%2020251110113817.png)

根据文件名在数据库中找到对应的请求, 找到请求的 URL 为 `https://api-normal.doubao.com/im/chain/single`:

![Pasted image 20251110113924.png](./attachments/Pasted%20image%2020251110113924.png)

在数据库中过滤该 URL, 找到最后一条请求:

![Pasted image 20251110114029.png](./attachments/Pasted%20image%2020251110114029.png)

在缓存中搜索文件名与该请求的 `SESSION_ID` 一致的文件:

![Pasted image 20251110114148.png](./attachments/Pasted%20image%2020251110114148.png)

一个是请求, 一个是响应, 查看响应. 然而这个包是空的, 只有豆包的推荐内容.

再往前看一条:

![Pasted image 20251110114502.png](./attachments/Pasted%20image%2020251110114502.png)

Cyberchef 格式化一下 JSON:

![Pasted image 20251110115113.png](./attachments/Pasted%20image%2020251110115113.png)
...
![Pasted image 20251110131339.png](./attachments/Pasted%20image%2020251110131339.png)
...
![Pasted image 20251110131750.png](./attachments/Pasted%20image%2020251110131750.png)

可以在应用的数据目录 `/media/0/Android/data/com.bfengtech.diange.diangeapp/files/diange/files/` 中找到这些文件:

![Pasted image 20251110131835.png](./attachments/Pasted%20image%2020251110131835.png)

然而这些文件还有另外一种获取方式. 由于电鸽的 API 并没有对访问做任何鉴权, 只要拿到文件的 URL, 任何人都可以直接下载这些文件:

![Pasted image 20251110132241.png](./attachments/Pasted%20image%2020251110132241.png)
...
![Pasted image 20251110135433.png](./attachments/Pasted%20image%2020251110135433.png)
...
![Pasted image 20251110131153.png](./attachments/Pasted%20image%2020251110131153.png)
...
![Pasted image 20251110135959.png](./attachments/Pasted%20image%2020251110135959.png)

查看转入的那条交易的信息:

![Pasted image 20251110140056.png](./attachments/Pasted%20image%2020251110140056.png)

嫌疑人表示钱已转过去时是 `2025-10-23 09:50:22`, 转账发生在 `2025-10-23 09:47:23`, 交易记录与聊天记录的时间先后顺序也能对上:

![Pasted image 20251110140208.png](./attachments/Pasted%20image%2020251110140208.png)

紧挨着的转出交易, 卖家又将收到的虚拟货币通过 Coinhako(一个新加坡的虚拟货币交易平台)卖出, 时间是 `2025-10-23 09:57:11`:

![Pasted image 20251110140532.png](./attachments/Pasted%20image%2020251110140532.png)
...
![Pasted image 20251110141107.png](./attachments/Pasted%20image%2020251110141107.png)

奇怪的是火绒这次居然没有报毒, 根据后续的分析判断, 这个程序其实不具有恶意功能, 只是模仿了一些远控的行为.

![Pasted image 20251110141311.png](./attachments/Pasted%20image%2020251110141311.png)
...
![Pasted image 20251110141455.png](./attachments/Pasted%20image%2020251110141455.png)
...
![Pasted image 20251110142331.png](./attachments/Pasted%20image%2020251110142331.png)
...
![Pasted image 20251110142547.png](./attachments/Pasted%20image%2020251110142547.png)

用 UPX4.10 去壳:

![Pasted image 20251110143524.png](./attachments/Pasted%20image%2020251110143524.png)
...
![Pasted image 20251110144308.png](./attachments/Pasted%20image%2020251110144308.png)

跟进新线程的函数 `post_pgo_initialization`, 里面也是调用了一个函数, 继续跟进 `sub_1400019B0`:

![Pasted image 20251110144511.png](./attachments/Pasted%20image%2020251110144511.png)

开了个 Socket 连接, ip 地址是 `192.168.93.129`, 端口是 `4444`. 之后看起来会远程接受 Socket 传入的数据, 作为命令通过 cmd 执行:

![Pasted image 20251110144825.png](./attachments/Pasted%20image%2020251110144825.png)
...
![Pasted image 20251110145329.png](./attachments/Pasted%20image%2020251110145329.png)

找到调用字符串的函数:

![Pasted image 20251110145418.png](./attachments/Pasted%20image%2020251110145418.png)
...
![Pasted image 20251110151024.png](./attachments/Pasted%20image%2020251110151024.png)

用 DIE 查看信息:

![Pasted image 20251110151111.png](./attachments/Pasted%20image%2020251110151111.png)
...
![Pasted image 20251110151234.png](./attachments/Pasted%20image%2020251110151234.png)
...
![Pasted image 20251110152227.png](./attachments/Pasted%20image%2020251110152227.png)

在 Kimi 的分析结果中, 可以看到用户用 Kimi 生成的小说原文, 是参考《钢铁是怎样炼成的》生成的:

![Pasted image 20251110152509.png](./attachments/Pasted%20image%2020251110152509.png)
...
![Pasted image 20251110170657.png](./attachments/Pasted%20image%2020251110170657.png)

找到的文件里面是 JSON 格式的数据, 用 VSCode 打开, 再次搜索, 翻了一会儿找到了:

![Pasted image 20251110170623.png](./attachments/Pasted%20image%2020251110170623.png)
...
![Pasted image 20251110171234.png](./attachments/Pasted%20image%2020251110171234.png)

在应用的数据目录中可以看到电脑密码和 BitLocker 密码:

![Pasted image 20251110171348.png](./attachments/Pasted%20image%2020251110171348.png)
...
![Pasted image 20251111150834.png](./attachments/Pasted%20image%2020251111150834.png)
...
![Pasted image 20251111151413.png](./attachments/Pasted%20image%2020251111151413.png)

容器的密码在剪贴板的固定项中, 需要仿真后按下 `Win + V` 才能看到:

![Pasted image 20251111152327.png](./attachments/Pasted%20image%2020251111152327.png)
...
![Pasted image 20251111153014.png](./attachments/Pasted%20image%2020251111153014.png)
...
![Pasted image 20251111162130.png](./attachments/Pasted%20image%2020251111162130.png)

导出之后计算哈希值:

![Pasted image 20251111162319.png](./attachments/Pasted%20image%2020251111162319.png)
...
![Pasted image 20251111162628.png](./attachments/Pasted%20image%2020251111162628.png)

编辑导出的哈希, 去掉首尾的文件名和冒号. HashCat 爆破:

![Pasted image 20251111163034.png](./attachments/Pasted%20image%2020251111163034.png)

得到解压密码是 `VteGElLDQu`. 或者也可以用 Passware, 添加一下字典就行.

解压之后里面有 30 个 Excel 表格文件, 比较多, 内容大概是:

![Pasted image 20251111163325.png](./attachments/Pasted%20image%2020251111163325.png)
...
![Pasted image 20251111164340.png](./attachments/Pasted%20image%2020251111164340.png)
...
![Pasted image 20251111164822.png](./attachments/Pasted%20image%2020251111164822.png)

![Pasted image 20251111164856.png](./attachments/Pasted%20image%2020251111164856.png)
...
![Pasted image 20251111171459.png](./attachments/Pasted%20image%2020251111171459.png)

打开的时候 IrfanView 报错了, 但是其他查看器又能打开, 应该是 CRC 校验没过:

![Pasted image 20251111171531.png](./attachments/Pasted%20image%2020251111171531.png)

![Pasted image 20251111171624.png](./attachments/Pasted%20image%2020251111171624.png)

跑一下 PNG 宽高检查, 发现真实的高度应该是 442 像素:

![Pasted image 20251111171638.png](./attachments/Pasted%20image%2020251111171638.png)

修改高度:

![Pasted image 20251111171750.png](./attachments/Pasted%20image%2020251111171750.png)

里面隐写了个 BitLocker 的恢复密钥:

![Pasted image 20251111171840.png](./attachments/Pasted%20image%2020251111171840.png)
...
![Pasted image 20251111173909.png](./attachments/Pasted%20image%2020251111173909.png)

在 `AAct.exe` 的属性中也可以看到:

![Pasted image 20251111174209.png](./attachments/Pasted%20image%2020251111174209.png)
...
![Pasted image 20251111174642.png](./attachments/Pasted%20image%2020251111174642.png)

在仿真系统中运行, 查看关于信息:

![Pasted image 20251111174816.png](./attachments/Pasted%20image%2020251111174816.png)

在 `C:/Program Files/Cryptomator/app/Cryptomator.cfg` 文件中也可以看到应用的具体版本:

![Pasted image 20251111175049.png](./attachments/Pasted%20image%2020251111175049.png)
...
![Pasted image 20251111165138.png](./attachments/Pasted%20image%2020251111165138.png)

其中有一堆单词, 最后几个单词被设置成白色, 又是隐写:

![Pasted image 20251111180823.png](./attachments/Pasted%20image%2020251111180823.png)

在仿真系统中运行 Cryptomator, 使用恢复密钥重置保险保险库的密码:

![Pasted image 20251111181016.png](./attachments/Pasted%20image%2020251111181016.png)

之后用重置后的密码解锁并挂载保险库:

![Pasted image 20251111181133.png](./attachments/Pasted%20image%2020251111181133.png)
...
![Pasted image 20251111181432.png](./attachments/Pasted%20image%2020251111181432.png)
...
![Pasted image 20251111191646.png](./attachments/Pasted%20image%2020251111191646.png)

爬取的小说数据内有 961 个文件, 每个文件都是 1 个章节:

![Pasted image 20251111191619.png](./attachments/Pasted%20image%2020251111191619.png)
...
![Pasted image 20251111192354.png](./attachments/Pasted%20image%2020251111192354.png)
...
![Pasted image 20251111193932.png](./attachments/Pasted%20image%2020251111193932.png)
...
![Pasted image 20251111192704.png](./attachments/Pasted%20image%2020251111192704.png)
...
![Pasted image 20251111194330.png](./attachments/Pasted%20image%2020251111194330.png)
...
![Pasted image 20251111201213.png](./attachments/Pasted%20image%2020251111201213.png)
...
![Pasted image 20251111201518.png](./attachments/Pasted%20image%2020251111201518.png)

运行 Floorp 浏览器之后, 在关于中可以看到:

![Pasted image 20251111201636.png](./attachments/Pasted%20image%2020251111201636.png)
...
![Pasted image 20251111201944.png](./attachments/Pasted%20image%2020251111201944.png)

或者在 Floorp 的历史记录中也能看到 Open WebUI 的 URL:

![Pasted image 20251111202104.png](./attachments/Pasted%20image%2020251111202104.png)
...
![Pasted image 20251111202144.png](./attachments/Pasted%20image%2020251111202144.png)
...
![Pasted image 20251111202734.png](./attachments/Pasted%20image%2020251111202734.png)

第五章的标题:

![Pasted image 20251111202809.png](./attachments/Pasted%20image%2020251111202809.png)
...
![Pasted image 20251111202842.png](./attachments/Pasted%20image%2020251111202842.png)

内容是律师事务所发送的邮件:

![Pasted image 20251111211536.png](./attachments/Pasted%20image%2020251111211536.png)
...
![Pasted image 20251111212342.png](./attachments/Pasted%20image%2020251111212342.png)

火眼的网络位置分析结果中也能看到:

![Pasted image 20251111212451.png](./attachments/Pasted%20image%2020251111212451.png)
...
![Pasted image 20251111212210.png](./attachments/Pasted%20image%2020251111212210.png)

![Pasted image 20251111212223.png](./attachments/Pasted%20image%2020251111212223.png)
