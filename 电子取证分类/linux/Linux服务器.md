## 一、Mysql 数据库[¶](https://forensics.xidian.edu.cn/wiki/linux3/#mysql "Permanent link")
...
## 二、文件服务器（FTP，SMB，NAS）[¶](https://forensics.xidian.edu.cn/wiki/linux3/#ftpsmbnas "Permanent link")

磁盘阵列参考：

### FTP[¶](https://forensics.xidian.edu.cn/wiki/linux3/#ftp "Permanent link")
...
### Samba[¶](https://forensics.xidian.edu.cn/wiki/linux3/#samba "Permanent link")

Samba 是使用SMB 协议的一款软件。SMB 协议用来在Linux 与Windows 系统之间无痛共享存储与打印机

### NAS[¶](https://forensics.xidian.edu.cn/wiki/linux3/#nas "Permanent link")
...
## 三、防火墙（iptables）[¶](https://forensics.xidian.edu.cn/wiki/linux3/#iptables "Permanent link")

## 四、SSH[¶](https://forensics.xidian.edu.cn/wiki/linux3/#ssh "Permanent link")
...
1、[http://www.xlysoft.net/detail/7-314-1194.html](http://www.xlysoft.net/detail/7-314-1194.html) 效率源科技 如何对有访问密码的MySQL数据库进行取证

2、[https://blog.csdn.net/hancoder/article/details/100988807](https://blog.csdn.net/hancoder/article/details/100988807) ubuntu下ftp的配置