...
## 一、常见的Linux 发行版[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#linux "Permanent link")
...
对于Debian 及其衍生版： `cat \etc\issue` `cat \etc\issue[dot]net` `cat \etc\lsb-release` `cat \etc\os-release`

对于CentOS： `cat \etc\centos-release` 对于Fedora： `cat \etc\fedora-release`

## 二、Linux 系统的典型目录结构（Dir Structure）[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#linux-dir-structure "Permanent link")
...
## 三、Linux 系统重要文件夹与文件的内容[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#linux_1 "Permanent link")
...
## 四、Linux 文件的属性（File Attribute）[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#linux-file-attribute "Permanent link")

### 查看文件或文件夹的权限[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#_1 "Permanent link")
...
### 如何修改文件或文件夹的权限：[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#_2 "Permanent link")
...
## 五、文件系统（File System）[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#file-system "Permanent link")
...
## 六、常见的系统功能[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#_3 "Permanent link")

### 1、NTP 时间同步[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#1ntp "Permanent link")

NTP 服务使用UDP123 端口与NTP服务器通信，更新系统时间，ntp 服务器配置保存在/etc/ntp.conf 文件中

### 2、Bash[¶](https://forensics.xidian.edu.cn/wiki/Linux1/#2bash "Permanent link")
...
> 
> 来源：[https://sspai.com/post/52868](https://sspai.com/post/52868)

每个用户的用户文件夹下都有该用户的Bash 历史记录（~/.bash_history），可以检索执行过的命令

参考：

1、 [https://linux.cn/article-9586-1.html](https://linux.cn/article-9586-1.html) 查看Linux发行版名称与版本号的8种方法

2、 [https://www.cnblogs.com/zhuchenglin/p/8686924.html](https://www.cnblogs.com/zhuchenglin/p/8686924.html) Linux 各个目录的详细介绍

3、 [https://www.cnblogs.com/123-/p/4189072.html](https://www.cnblogs.com/123-/p/4189072.html) Linux下用户组、文件权限详解